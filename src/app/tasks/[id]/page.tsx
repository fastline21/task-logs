...
const SingleTaskPage = () => {
	...
	if (TaskQuery.isLoading) {
		return <ProgressBar isLoading={TaskQuery.isLoading} />;
	}
		...
		<>
			<Container maxW="container.md">
				<Box my="3">
					<Text
						fontSize="3xl"
						onClick={() => handleCopyData(TaskQuery.data.description)}
						className="pointer"
					>
				...
				<Box my="3">
					<Text fontSize="md">
						<span
							onClick={() => handleCopyData(TaskQuery.data.service.name)}
							className="pointer"
						>
						...
						-{' '}
						<span
							onClick={() => handleCopyData(TaskQuery.data.source.name)}
							className="pointer"
						>
								...
								<Tr>
									...
									<Td
										onClick={() =>
											handleCopyData(
												getDateFormat({
													date: TaskQuery.data.task_date_start,
									...
									<Td
										onClick={() =>
											handleCopyData(
												getDateFormat({
													date: TaskQuery.data.task_date_start,
													formatDate: TIME_FORMAT.TWELVE_HOURS,
												})
											)
										}
										className="pointer"
									...
									<Td
										onClick={() =>
											handleCopyData(
												getDateFormat({
													date: TaskQuery.data.task_date_start,
													formatDate: TIME_FORMAT.TWENTY_FOUR_HOURS,
												})
											)
										}
										className="pointer"
