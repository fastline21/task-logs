...
const CreateServicePage = () => {
	...
	return (
		<>
			<ProgressBar isLoading={ServiceMutation.isLoading} />
			<Container maxW="container.md">
				...
				<Box>
					<form onSubmit={ServiceQuery.handleSubmit(onSubmit)}>
						<Box my="3">
							<FormControl
								isInvalid={ServiceQuery.formState.errors.name ? true : false}
							>
								...
								/>
								<FormErrorMessage>
									{ServiceQuery.formState.errors.name?.message}
								</FormErrorMessage>
							</FormControl>
						</Box>
						<Box my="3">
							<FormControl
								isInvalid={
									ServiceQuery.formState.errors.description ? true : false
								}
							>
								<FormLabel>Description</FormLabel>
								<Input type="text" {...ServiceQuery.register('description')} />
								<FormErrorMessage>
									{ServiceQuery.formState.errors.description?.message}
								</FormErrorMessage>
							</FormControl>
						</Box>
						<Box my="3">
